...
// Test players with REAL UUIDs from Mojang API
const testPlayers = [
    { username: 'LiamGTI', uuid: '0fc533c4ac494d09a4188138e6f061ac' },
    { username: 'Technoblade', uuid: 'b876ec32e396476ba1158438d83c67d4' },
    { username: 'Dream', uuid: 'ec70bcaf702f4bb8b48d276fa52a780c' },
    { username: 'GeorgeNotFound', uuid: 'bd3dd5a404384699b2fd36f518154b41' },
    { username: 'Sapnap', uuid: 'c66f7c8aed0c446990b0421d8ff7ca49' },
    { username: 'BadBoyHalo', uuid: '8192d8c0-4a25-4f8e-8b5d-8c8c8c8c8c8f' }, // Fake - will need real one
    { username: 'Antfrost', uuid: '8192d8c0-4a25-4f8e-8b5d-8c8c8c8c8c90' }, // Fake - will need real one
    { username: 'Punz', uuid: '8192d8c0-4a25-4f8e-8b5d-8c8c8c8c8c91' }, // Fake - will need real one
    { username: 'FoolishGamers', uuid: '8192d8c0-4a25-4f8e-8b5d-8c8c8c8c8c92' }, // Fake - will need real one
    { username: 'Ranboo', uuid: '8192d8c0-4a25-4f8e-8b5d-8c8c8c8c8c93' } // Fake - will need real one
];
...
async function addTestData() {
    console.log('🚀 Adding test data with REAL UUIDs...');
    ...
    try {
        ...
        console.log('- /search Dream - Search for players');
        console.log('- /profile GeorgeNotFound - View profiles');
